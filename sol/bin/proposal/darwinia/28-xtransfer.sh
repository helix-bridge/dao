...
LNBRIDGE=0x8c585F9791EE5b4B23fe82888cE576DBB69607eB
...
data2=$(seth calldata "burnAndRemoteUnlockNative(uint32,uint256,address,uint256)" 6501 2000000 0x2401224012bAE7C2f217392665CA7abC16dCDE1e $wad)
datas=[$data1,$data2]
